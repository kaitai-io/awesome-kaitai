...
- [Main Website](http://kaitai.io) ([Umbrella Repository](https://github.com/kaitai-io/kaitai_struct), [Github Pages](https://github.com/kaitai-io/kaitai-io.github.io), [Wiki](https://github.com/kaitai-io/kaitai_struct/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct/issues))
...
- Kaitai Struct: visualizer and hex viewer tool GUI in Java ([Repository](https://github.com/kaitai-io/kaitai_struct_gui), [Wiki](https://github.com/kaitai-io/kaitai_struct_gui/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_gui/issues)) - *deprecated?*
...
- Windows resource file spec for Kaitai Struct ([Repository](https://github.com/kaitai-io/windows_resource_file.ksy), [Wiki](https://github.com/kaitai-io/windows_resource_file.ksy/wiki), [Issues](https://github.com/kaitai-io/windows_resource_file.ksy/issues))
...
- [Stackoverflow](http://stackoverflow.com/questions/tagged/kaitai-struct)
- [Gitter channel](https://gitter.im/kaitai_struct/)
- [Official Twitter account](https://twitter.com/kaitai_io)

## Runtimes

- C++ using STL ([Repository](https://github.com/kaitai-io/kaitai_struct_cpp_stl_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_cpp_stl_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_cpp_stl_runtime/issues))
- C#/.NET ([Repository](https://github.com/kaitai-io/kaitai_struct_csharp_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_csharp_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_csharp_runtime/issues))
- Go ([Repository](https://github.com/kaitai-io/kaitai_struct_go_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_go_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_go_runtime/issues))
- JavaScript ([Repository](https://github.com/kaitai-io/kaitai_struct_javascript_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_javascript_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_javascript_runtime/issues))
  - Examples ([Repository](https://github.com/kaitai-io/kaitai_struct_examples), [Wiki](https://github.com/kaitai-io/kaitai_struct_examples/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_examples/issues))
...
- Java ([Repository](https://github.com/kaitai-io/kaitai_struct_java_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_java_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_java_runtime/issues))
- Lua ([Repository](https://github.com/kaitai-io/kaitai_struct_lua_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_lua_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_lua_runtime/issues))
- Perl ([Repository](https://github.com/kaitai-io/kaitai_struct_perl_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_perl_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_perl_runtime/issues))
- PHP ([Repository](https://github.com/kaitai-io/kaitai_struct_php_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_php_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_php_runtime/issues))
- Python ([Repository](https://github.com/kaitai-io/kaitai_struct_python_runtime), [Issues](https://github.com/kaitai-io/kaitai_struct_python_runtime/issues))
  - [PIP packet](https://pypi.python.org/pypi/kaitaistruct)
- Ruby ([Repository](https://github.com/kaitai-io/kaitai_struct_ruby_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_ruby_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_ruby_runtime/issues))
- Rust ([Repository](https://github.com/kaitai-io/kaitai_struct_rust_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_rust_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_rust_runtime/issues))
- Swift ([Repository](https://github.com/kaitai-io/kaitai_struct_swift_runtime), [Wiki](https://github.com/kaitai-io/kaitai_struct_swift_runtime/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_swift_runtime/issues))
...
- Benchmarking suite ([Repository](https://github.com/kaitai-io/kaitai_struct_benchmarks), [Wiki](https://github.com/kaitai-io/kaitai_struct_benchmarks/wiki), [Issues](https://github.com/kaitai-io/kaitai_struct_benchmarks/issues))
...
- KaitaiFS: mount any filesystem specified with a .ksy as a real file system ([Repository](https://github.com/kaitai-io/kaitai_fs), [Wiki](https://github.com/kaitai-io/kaitai_fs/wiki), [Issues](https://github.com/kaitai-io/kaitai_fs/issues))
...
- https://fosdem.org/2017/schedule/event/om_kaitai/ - Presentation on Kaitai from Mikhail Yakshin (GreyCat)
